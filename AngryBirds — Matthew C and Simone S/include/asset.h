 ...
 */
typedef void (*button_handler_t)(void *state, bool mouse_type, double x,
                                 double y);
...
/**
 * Returns the body associated with an asset.
 * @param asset the image asset to get the body from.
 */
bool asset_body_removed(asset_t *asset);

body_t *get_body(asset_t *asset);
